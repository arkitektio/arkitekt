...
class MagicBar(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.fakts.loaded_signal.connect(self.on_fakts_loaded)
    ...
    def on_fakts_loaded(self):
        self.set_unconnected()

    def on_fakts_deleted(self):
        self.set_unkonfigured()

    def on_herre_login(self):
        self.set_unprovided()

    def on_herre_logout(self):
        self.set_unconnected()

    def on_agent_provide(self):
        self.set_providing()

    def on_agent_unprovide(self):
        self.set_halted()
    ...
    def set_unkonfigured(self):
        self.magicb_movie = QtGui.QMovie(
            get_image_path("pink pulse.gif", darkMode=self.darkMode)
        )
    ...
    def set_fakts_loading(self):
        self.magicb_movie = QtGui.QMovie(
            get_image_path("pink pulse.gif", darkMode=self.darkMode)
        )
        self.magicb_movie.frameChanged.connect(self.update_movie)
        self.magicb_movie.start()
        self.magicb.setDisabled(True)
        self.magicb.setText("Konfiguring...")

    def set_unconnected(self):
        self.magicb_movie = QtGui.QMovie(
            get_image_path("green pulse.gif", darkMode=self.darkMode)
        )
        self.magicb_movie.frameChanged.connect(self.update_movie)
        self.magicb.setDisabled(False)
        self.magicb_movie.start()
    ...
    def set_herre_loading(self):
        ...
        self.magicb_movie.start()
        self.magicb.setDisabled(True)
        self.magicb.setText("Connecting...")

    def set_halted(self):
        self.magicb_movie = QtGui.QMovie(
            get_image_path("orange pulse.gif", darkMode=self.darkMode)
        )
        self.magicb_movie.frameChanged.connect(self.update_movie)
        self.magicb_movie.start()
        self.magicb.setDisabled(False)
