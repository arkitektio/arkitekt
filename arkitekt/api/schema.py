from typing import Optional, List, Literal, AsyncIterator, Union, Any, Iterator, Dict
from arkitekt.scalars import QString
from pydantic import BaseModel, Field
from enum import Enum
from arkitekt.funcs import subscribe, execute, asubscribe, aexecute
